enum errorLookupMessage {
    DOES_NOT_CREATED = "Lookup doesn't created",
    DOES_NOT_UPDATED = "Lookup doesn't updated",
    DOES_NOT_DELETED = "Lookup doesn't deleted",
    NOT_FOUND_LOOKUP = 'This Lookup does not exist',
...
export default errorLookupMessage;